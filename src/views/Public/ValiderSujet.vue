            ...
            <div class="d-flex">
              ...
              <div class="forum-message__header">
                ...
                <div class="forum-message__meta">
                  <a href="#message-139346"
                    ><time-ago time="1692365782">
                      , Il y a {{ formatRelativeDate(comment.createdAt) }}</time-ago
                    ></a
                  >
              ...
              <div class="form-group">
                ...
                <div class="mdeditor">
                  <div class="mdeditor__toolbar">
                    <div class="mdeditor__toolbarleft"></div>
                    <div class="mdeditor__toolbarright"></div>
                  </div>
                </div>
                <textarea
                  id="forum_topic_form_content"
                  class="form-control"
                  v-model="contenu"
                >
                </textarea>
                <small v-if="v$.contenu.$error && contenu.trim() !== ''">{{
                  v$.contenu.$errors[0].$message
                }}</small>
              </div>
