  ...
  export default {
    ...
    computed: {
      ...
      totalPages() {
        ...
        return Math.ceil(this.InfluentOptions.length / this.itemsPerPage);
      },
      paginatedItems() {
        const startIndex = (this.currentPage - 1) * this.itemsPerPage;
        const endIndex = startIndex + this.itemsPerPage;
        return this.InfluentOptions.slice(startIndex, endIndex);
      },
    },
    ...
    mounted() {
      console.log("data", this.InfluentOptions);
    },
    ...
    methods: {
      ...
      async confirmDelete() {
        ...
        try {
          ...
          if (response.data.statut === "success") {
            this.InfluentOptions;
            this.$emit("data-updated", this.InfluentOptions);
      ...
      updatedoc(id) {
        ...
        this.isOpen = true;
        this.GetUpdateUser = this.InfluentOptions;
