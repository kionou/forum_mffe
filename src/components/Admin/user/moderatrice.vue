  ...
  export default {
    ...
    computed: {
      ...
      totalPages() {
        ...
        return Math.ceil(this.ModerateurOptions.length / this.itemsPerPage);
      },
      paginatedItems() {
        const startIndex = (this.currentPage - 1) * this.itemsPerPage;
        const endIndex = startIndex + this.itemsPerPage;
        return this.ModerateurOptions.slice(startIndex, endIndex);
      },
    },
    ...
    mounted() {
      console.log("data", this.ModerateurOptions);
    },
    ...
    methods: {
      ...
      async confirmDelete() {
        ...
        try {
          ...
          if (response.data.statut === "success") {
            this.ModerateurOptions;
            this.$emit("data-updated", this.ModerateurOptions);
      ...
      updatedoc(id) {
        ...
        this.isOpen = true;
        this.GetUpdateUser = this.ModerateurOptions;
